...
export function queryTableJoinList (query) {
  return request({
    url: '/code/generator/table/join/list',
    method: 'get',
    params: query
  })
}
...
export function createTableJoin (data) {
  return request({
    url: '/code/generator/table/join/create',
    method: 'post',
    data
  })
}
...
export function updateTableJoin (data) {
  return request({
    url: '/code/generator/table/join/update',
    method: 'post',
    data
  })
}
...
export function updateTableJoinStatus (tableJoinId, status) {
  return request({
    url: '/code/generator/table/join/status/' + tableJoinId + '/' + status,
    method: 'post'
  })
}
...
export function batchDeleteTableJoin (data) {
  return request({
    url: '/code/generator/table/join/batch/delete',
    method: 'post',
    data
  })
}
...
export function deleteTableJoin (id) {
  return request({
    url: '/code/generator/table/join/delete/' + id,
    method: 'post'
  })
}
