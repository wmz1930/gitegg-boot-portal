...
export function batchDeleteMailLog (data) {
  return request({
    url: '/extension/mail/log/batch/delete',
    method: 'post',
    data
  })
}
...
export function deleteMailLog (id) {
  return request({
    url: '/extension/mail/log/delete/' + id,
    method: 'post'
  })
}
...
export function downloadMailLogList (query) {
  return request({
    url: '/extension/mail/log/download',
    method: 'get',
    responseType: 'blob',
    params: query
  })
...
export function downloadMailLogTemplate (query) {
  return request({
    url: '/extension/mail/log/download/template',
    method: 'get',
    responseType: 'blob',
    params: query
  })
